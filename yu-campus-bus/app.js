...
const ROUTES = {
  r1: {
    ...
    stops: [
      stop('r1-1','국제교류센터 주차장 입구 횡단보도','A02',['국제교류센터','YU International Center','영남대역 4번출구'],[35.83676,128.75442],'천연잔디축구장 앞',0,'영남대역 4번출구, 대구은행, 시내·시외버스 환승'),
      stop('r1-2','중앙도서관 횡단보도','B04',['중앙도서관','사범대학 사이'],[35.83526,128.75950],'사범대학 건너편',0,'중앙도서관, 학생회관 학식, GS25, 사범대, 정행대, 스타벅스'),
      stop('r1-3','예술대학 음악관 옆 중앙테니스장 주차장','A10/A09',['음악대학','음악관','중앙테니스장','예술대학'],[35.83516,128.76131],'양방향 정차 가능 구간',0,'음대, 중앙테니스장, 동문 방향'),
      stop('r1-4','인문관 강당 앞','B03',['인문관','인문관 강당','종강'],[35.83398,128.76029],'천마관 건너편',0,'인문관, 인문관강당, 종합강의동, 제2인문관'),
      stop('r1-5','인문관 정문 앞','B03',['인문관 정문','대학본부'],[35.83298,128.75899],'대학본부·제1과학관 방향',0,'인문관, 대학본부, 제1과학관 방향 이동에 유리'),
      stop('r1-6','서문 인조잔디축구장 앞','서문',['서문','인조잔디축구장','기숙사'],[35.83255,128.75190],'5분 정차 · 순환지점',DWELL_SECONDS,'기숙사, 서문, 남매지, 축구장'),
      stop('r1-7','제1과학관 횡단보도','F21',['제1과학관','정보전산원'],[35.83025,128.75749],'정보전산원 일방통행 오르막길 옆',0,'제1과학관, 생활과학대학, 거울못, 대학본부'),
      stop('r1-8','천마관','C03',['천마관','종합강의동','General Lecture Hall'],[35.83330,128.76082],'인문관 건너편',0,'천마관, 인문관 반대편 승하차 지점'),
      stop('r1-9','예술대학 음악관 옆 중앙테니스장 주차장','A10/A09',['음악대학','음악관','중앙테니스장','예술대학'],[35.83502,128.76156],'복귀 방향 정차',0,'음대 복귀 방향 정차'),
      stop('r1-10','사범대학 앞','A08',['사범대학','College of Education'],[35.83492,128.75986],'중앙도서관 건너편 횡단보도',0,'사범대, 중앙도서관, 상경관, 정행대'),
      stop('r1-11','국제교류센터 주차장 입구 횡단보도','A02',['국제교류센터','YU International Center','영남대역 4번출구'],[35.83661,128.75466],'천연잔디축구장 건너편',0,'기점 복귀 지점')
    ]
  },
  r2: {
    id: 'r2',
    ...
    guideNote: '현재 공식 12개 정류장 체계를 유지하되, 정차 위치는 손그림 이미지와 설명을 참고해 보정했습니다.',
    stops: [
      stop('r2-1','노천강당 입구','B01',['노천강당','Amphitheater','영남대역 3번출구'],[35.83628,128.75788],'천마로 방향 · 차량출입 통제구역 끝',0,'상경관, 우체국, 영남대역 3번출구'),
      stop('r2-2','제1과학관 횡단보도','F21',['제1과학관','정보전산원'],[35.83025,128.75749],'정보전산원 일방통행 오르막길 옆',0,'제1과학관, 정보전산원'),
      stop('r2-3','제2과학관 옆','F22',['제2과학관'],[35.83006,128.75893],'생활과학대학 건너편',0,'제2과학관, 제3과학관, 법전원, 러브로드'),
      stop('r2-4','생명응용과학대학 본관 오르막길 앞','F27',['생명응용과학대학','생명응용과학대 본관','자연계학식'],[35.82850,128.75879],'약학관 건너편',0,'생명응용과학대학, 자연계 학식, 이종우과학도서관, 약대'),
      stop('r2-5','기계관 옆 자전거 보관소','E29',['기계관','자전거 보관소'],[35.82695,128.75683],'후문·삼풍동 방향',0,'기계관, 소재관, 자동차관, 로봇관, 후문 방향'),
      stop('r2-6','천마아트센터 주차장 입구 앞','E02',['천마아트센터','Chunma Art Center'],[35.83286,128.75262],'서문 직전 서측 정차',0,'천마아트센터, 서문 접근 정류장'),
      stop('r2-7','서문 인조잔디축구장 앞','서문',['서문','인조잔디축구장','기숙사'],[35.83255,128.75190],'5분 정차 · 순환지점',DWELL_SECONDS,'기숙사, 서문, 남매지, 축구장'),
      stop('r2-8','기계관 옆','E29',['기계관','Mechanical Engineering Building'],[35.82688,128.75709],'자전거보관소 건너편',0,'기계관 복귀 방향 정차'),
      stop('r2-9','약학관 앞','G07',['약학관'],[35.82792,128.75885],'생명응용과학대학 본관 오르막길 건너편',0,'약학관, 생명응용과학대학 반대편'),
      stop('r2-10','생활과학대학 옆','G01',['생활과학대학','생활과학대학 본관'],[35.82995,128.75920],'제2과학관 건너편',0,'생활과학대학, 제2과학관 반대편'),
      stop('r2-11','중앙도서관 정문 부근 횡단보도','B04',['중앙도서관','상경관'],[35.83548,128.75931],'상경관·정행대 접근',0,'중앙도서관, 상경관, 정치행정대학, 스타벅스, 중도학식'),
      stop('r2-12','노천강당 입구','B01',['노천강당','Amphitheater','영남대역 3번출구'],[35.83635,128.75799],'천마로 방향 · 차량출입 통제구역 끝',0,'기점 복귀 지점')
    ]
  }
};
...
const state = {
  ...
  planLayers: [],
  routeModels: {},
  layerVisibility: { route1: true, route2: true, buses: true, pmZones: true },
...
function makeStopIcon(routeId, index, both = false) {
  const cls = both ? 'stop-both' : routeId === 'r1' ? 'stop-r1' : 'stop-r2';
  return L.divIcon({ className: '', html: `<div class="stop-icon ${cls}">${index}</div>`, iconSize: [24, 24], iconAnchor: [12, 12] });
}
function makeBusIcon(label) {
  return L.divIcon({ className: '', html: `<div class="bus-icon">${label}</div>`, iconSize: [40, 24], iconAnchor: [20, 12] });
}
...
function makeCrowdBusIcon(routeLabel) { return L.divIcon({ className:'', html:`<div class="crowd-bus-icon">${routeLabel} 공유</div>`, iconSize:[52,28], iconAnchor:[26,14] }); }
...
function renderStops() {
  for (const routeId of ['r1', 'r2']) {
    ...
    route.stops.forEach((s, i) => {
      const duplicateOther = Object.values(ROUTES).some(r => r.id !== routeId && r.stops.some(o => o.coord && haversine(o.coord, s.coord) < 14));
      const marker = L.marker(s.coord, { icon: makeStopIcon(routeId, i + 1, duplicateOther) })
        .bindPopup(stopPopupHtml(route, s, i));
...
async function buildRouteModel(route) {
  ...
  try {
    ...
    const legs = r.legs.map((leg, i) => {
      ...
      return { duration: leg.duration, distance: leg.distance, coords };
    });
    const offsets = [0];
    let elapsed = 0;
...
function renderRoute(routeId) {
  ...
  const route = ROUTES[routeId];
  if (!model?.ok) return;
  const line = L.polyline(model.geometry, { color: route.color, weight: 6, opacity: .82, lineJoin: 'round' });
  if (state.layerVisibility[key]) line.addTo(map);
  state.routeLayers[routeId] = line;
}
...
function updateStatus(mode) {
  ...
  if (mode === 'ready') {
    ...
    const next = nextDispatchInfo(new Date());
...
function scheduleDate(time, base = new Date()) {
...
function activeTrips(routeId, now = new Date()) {
  const model = state.routeModels[routeId];
  if (!model?.ok) return [];
...
function predictedPoint(routeId, elapsed) {
  ...
  for (let i = 0; i < model.legs.length; i++) {
    ...
    if (t <= leg.duration) return { coord: pointAlong(leg.coords, t / leg.duration), label: `${i + 1}→${i + 2}` };
    t -= leg.duration;
    const arrived = route.stops[i + 1];
    if (arrived?.dwell) {
      if (t <= arrived.dwell) return { coord: arrived.coord, label: `${i + 1}번 다음 ${i + 2}번 정류장 정차` };
      t -= arrived.dwell;
    }
  }
  return { coord: route.stops.at(-1).coord, label: '종점' };
}

function updateBuses() {
  state.busLayers.forEach(l => map.removeLayer(l));
  state.busLayers = [];
  if (!state.layerVisibility.buses) return;
  const now = new Date();
  ['r1', 'r2'].forEach(routeId => {
    activeTrips(routeId, now).forEach(trip => {
      const crowdKey = `${routeId}|${tripKey(routeId, trip.time)}`;
      if (state.liveBusByTrip.has(crowdKey)) return;
      const p = predictedPoint(routeId, trip.elapsed);
      if (!p?.coord) return;
      const marker = L.marker(p.coord, { icon: makeBusIcon(ROUTES[routeId].short) })
        .bindPopup(`<strong>${ROUTES[routeId].name} 예상 차량</strong><br>${trip.time} 기준 출발 · ${escapeHtml(p.label)}<br><small>실제 GPS 위치가 아닙니다.</small>`)
        .addTo(map);
      state.busLayers.push(marker);
    });
  });
}
...
function renderCrowdBuses(rows = []) {
  state.crowdBusLayers.forEach(l => map.removeLayer(l));
  state.crowdBusLayers = [];
  ...
  for (const row of rows) {
    ...
    const marker = L.marker([row.lat, row.lng], { icon: makeCrowdBusIcon(route.short), zIndexOffset: 450 })
      .bindPopup(`<strong>${route.name} 탑승객 공유 위치</strong><br>${escapeHtml(row.tripKey)}<br><small>기여 ${row.contributors}명 · ${row.sampleAgeSeconds}초 전 · 실제 버스 GPS 아님</small>`)
      .addTo(map);
    state.crowdBusLayers.push(marker);
  }
}
...
function setUserLocation(coord, accuracy = null, recenter = true) {
  ...
  state.userLayer = L.marker(coord, { icon: makeUserIcon(), zIndexOffset: 1000 })
    .bindPopup(`현재 위치${accuracy ? `<br><small>정확도 약 ${Math.round(accuracy)}m</small>` : ''}`)
    .addTo(map);
...
async function footRoute(a, b) {
  ...
  try {
    ...
    console.warn('foot route fail', e);
    return { ok: false, error: e };
  }
}
...
function nextArrivalAtStop(routeId, stopIdx, now = new Date()) {
  const model = state.routeModels[routeId];
  if (!model?.ok) return null;
  const offset = model.offsets[stopIdx] || 0;
  const effective = new Date(EFFECTIVE_DATE + 'T00:00:00');
  if (now < effective) return null;
  for (const t of SCHEDULE) {
    const dep = scheduleDate(t, now);
    const arrival = new Date(dep.getTime() + offset * 1000);
    if (arrival >= now) return { departure: t, arrival, wait: (arrival - now) / 1000 };
  }
  return null;
}
...
async function planRoutes() {
  ...
  if (!state.user) {
    toast('먼저 현재 위치를 불러오세요.');
    requestLocation();
    return;
  }
  if (!state.destination) {
    const found = findDestinationByName(input);
  ...
  for (const routeId of ['r1', 'r2']) {
    ...
    const boards = route.stops
      .map((s, i) => ({ s, i, d: haversine(state.user, s.coord) }))
      .sort((a, b) => a.d - b.d)
      .slice(0, 3);
    const alights = route.stops
      .map((s, i) => ({ s, i, d: haversine(state.destination, s.coord) }))
      .sort((a, b) => a.d - b.d)
      .slice(0, 3);
    ...
    for (const b of boards) for (const a of alights) {
      ...
      const next = nextArrivalAtStop(routeId, b.i, new Date());
      if (!next) continue;
    ...
    const next = nextArrivalAtStop(routeId, candidate.b.i, new Date());
    if (!next) continue;
...
function drawPlan(plan) {
  ...
  const coords = [];
  for (let i = plan.boardIdx; i < plan.alightIdx; i++) coords.push(...model.legs[i].coords);
  const c = L.polyline(coords, { color: ROUTES[plan.routeId].color, weight: 8, opacity: .9 }).addTo(map);
  state.planLayers.push(a, b, c);
...
function nearestGuidanceStopIndex(g, coord) {
  ...
  const from = Math.max(g.plan.boardIdx, 0);
  const to = Math.min(g.plan.alightIdx, route.stops.length - 1);
...
function renderGuidance() {
  ...
  if (g.stage === 'to_board' || g.stage === 'waiting') {
    ...
    const remaining = Math.max(0, g.plan.alightIdx - nearestIdx);
...
document.getElementById('pickMapBtn').addEventListener('click', () => {
  ...
  toast(state.pickingDestination ? '지도에서 목적지를 눌러주세요.' : '지도 선택을 취소했습니다.');
});
...
map.on('click', e => {
  ...
  setDestination([e.latlng.lat, e.latlng.lng], '지도에서 선택한 위치');
  toast('목적지를 설정했습니다.');
});
...
document.querySelectorAll('.chip').forEach(btn => btn.addEventListener('click', () => {
  ...
  if (k === 'route1') {
    const l = state.routeLayers.r1;
    if (l) { state.layerVisibility[k] ? l.addTo(map) : map.removeLayer(l); }
    state.stopLayers.r1.forEach(x => state.layerVisibility[k] ? x.addTo(map) : map.removeLayer(x));
  }
  if (k === 'route2') {
    const l = state.routeLayers.r2;
    if (l) { state.layerVisibility[k] ? l.addTo(map) : map.removeLayer(l); }
